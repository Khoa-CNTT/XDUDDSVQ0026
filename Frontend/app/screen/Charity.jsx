import { View, Text, SafeAreaView, TouchableOpacity, Alert, ActivityIndicator, TextInput, ScrollView } from 'react-native'
        ...
        <SafeAreaView className="flex-1 bg-white">
            ...
            <ScrollView className="flex-1">
                ...
                <View className="px-6 mt-6">
                    <Text className="text-lg font-bold mb-4">Thông tin người quyên góp</Text>
                ...
                <View className="items-center mb-6">
                    {loading ? (
                        ...
                        <TouchableOpacity 
                            className={`rounded-lg py-4 w-[240px] ${selectedFile && name && email && title ? 'bg-purple-600' : 'bg-gray-400'}`}
                            onPress={donateBook}
