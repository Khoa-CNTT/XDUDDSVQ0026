    ...
    try {
      ...
      if (data.status && data.data) {
        ...
        setBook({
          ...
          image:
            typeof apiBook.image === "string"
              ? { uri: apiBook.image }
              : require("../../assets/images/bia1.png"),
          author: apiBook.author
            ? apiBook.author.name_author
            : "Không rõ tác giả",
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <View className="px-6 ">
          ...
          <View className="p-4 rounded-xl mb-6">
            ...
            <Text className="text-base leading-6">{book.description}</Text>
          </View>
      ...
      <View className="p-6 bottom-0 w-full left-0 right-0 bg-gray-100 flex-row justify-between items-center py-4">
        <Text className="text-black font-extrabold text-center text-xl ms-6">
          {book.price}
        </Text>
